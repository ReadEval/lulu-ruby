...
# Unit tests for Lulu::PrintJob
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintJob' do
  before do
    # run before each test
    @instance = Lulu::PrintJob.new
  end
  ...
  describe 'test an instance of PrintJob' do
    it 'should create an instance of PrintJob' do
      expect(@instance).to be_instance_of(Lulu::PrintJob)
    end
  end
