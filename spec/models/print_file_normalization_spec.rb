...
# Unit tests for Lulu::PrintFileNormalization
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintFileNormalization' do
  before do
    # run before each test
    @instance = Lulu::PrintFileNormalization.new
  end
  ...
  describe 'test an instance of PrintFileNormalization' do
    it 'should create an instance of PrintFileNormalization' do
      expect(@instance).to be_instance_of(Lulu::PrintFileNormalization)
    end
  end
