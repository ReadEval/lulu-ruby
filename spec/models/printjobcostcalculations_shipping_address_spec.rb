...
# Unit tests for Lulu::PrintjobcostcalculationsShippingAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintjobcostcalculationsShippingAddress' do
  before do
    # run before each test
    @instance = Lulu::PrintjobcostcalculationsShippingAddress.new
  end
  ...
  describe 'test an instance of PrintjobcostcalculationsShippingAddress' do
    it 'should create an instance of PrintjobcostcalculationsShippingAddress' do
      expect(@instance).to be_instance_of(Lulu::PrintjobcostcalculationsShippingAddress)
    end
  end
  describe 'test attribute "title"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["MR", "MISS", "MRS", "MS", "DR"])
