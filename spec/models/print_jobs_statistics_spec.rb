...
# Unit tests for Lulu::PrintJobsStatistics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintJobsStatistics' do
  before do
    # run before each test
    @instance = Lulu::PrintJobsStatistics.new
  end
  ...
  describe 'test an instance of PrintJobsStatistics' do
    it 'should create an instance of PrintJobsStatistics' do
      expect(@instance).to be_instance_of(Lulu::PrintJobsStatistics)
    end
  end
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["CREATED", "REJECTED", "UNPAID", "PAYMENT_IN_PROGRESS", "PRODUCTION_READY", "PRODUCTION_DELAYED", "IN_PRODUCTION", "ERROR", "SHIPPED", "CANCELED"])
