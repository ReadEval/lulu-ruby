...
# Unit tests for Lulu::PrintjobsStatusMessages
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintjobsStatusMessages' do
  before do
    # run before each test
    @instance = Lulu::PrintjobsStatusMessages.new
  end
  ...
  describe 'test an instance of PrintjobsStatusMessages' do
    it 'should create an instance of PrintjobsStatusMessages' do
      expect(@instance).to be_instance_of(Lulu::PrintjobsStatusMessages)
    end
  end
