...
# Unit tests for Lulu::PrintjobsPrintableNormalizationInterior
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintjobsPrintableNormalizationInterior' do
  before do
    # run before each test
    @instance = Lulu::PrintjobsPrintableNormalizationInterior.new
  end
  ...
  describe 'test an instance of PrintjobsPrintableNormalizationInterior' do
    it 'should create an instance of PrintjobsPrintableNormalizationInterior' do
      expect(@instance).to be_instance_of(Lulu::PrintjobsPrintableNormalizationInterior)
    end
  end
  ...
  describe 'test attribute "source_md5_sum"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "normalized_file"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
