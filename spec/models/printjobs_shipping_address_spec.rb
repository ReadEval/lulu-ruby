...
# Unit tests for Lulu::PrintjobsShippingAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintjobsShippingAddress' do
  before do
    # run before each test
    @instance = Lulu::PrintjobsShippingAddress.new
  end
  ...
  describe 'test an instance of PrintjobsShippingAddress' do
    it 'should create an instance of PrintjobsShippingAddress' do
      expect(@instance).to be_instance_of(Lulu::PrintjobsShippingAddress)
    end
  end
