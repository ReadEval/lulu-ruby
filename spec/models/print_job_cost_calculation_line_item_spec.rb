...
# Unit tests for Lulu::PrintJobCostCalculationLineItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintJobCostCalculationLineItem' do
  before do
    # run before each test
    @instance = Lulu::PrintJobCostCalculationLineItem.new
  end
  ...
  describe 'test an instance of PrintJobCostCalculationLineItem' do
    it 'should create an instance of PrintJobCostCalculationLineItem' do
      expect(@instance).to be_instance_of(Lulu::PrintJobCostCalculationLineItem)
    end
  end
