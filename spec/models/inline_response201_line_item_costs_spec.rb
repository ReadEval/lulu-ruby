...
# Unit tests for Lulu::InlineResponse201LineItemCosts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse201LineItemCosts' do
  before do
    # run before each test
    @instance = Lulu::InlineResponse201LineItemCosts.new
  end
  ...
  describe 'test an instance of InlineResponse201LineItemCosts' do
    it 'should create an instance of InlineResponse201LineItemCosts' do
      expect(@instance).to be_instance_of(Lulu::InlineResponse201LineItemCosts)
    end
  end
  ...
  describe 'test attribute "cost_excl_discounts"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "total_cost_excl_discounts"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "total_cost_excl_tax"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "total_cost_incl_tax"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "unit_tier_cost"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
