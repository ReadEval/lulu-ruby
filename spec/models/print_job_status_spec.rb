...
# Unit tests for Lulu::PrintJobStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintJobStatus' do
  before do
    # run before each test
    @instance = Lulu::PrintJobStatus.new
  end
  ...
  describe 'test an instance of PrintJobStatus' do
    it 'should create an instance of PrintJobStatus' do
      expect(@instance).to be_instance_of(Lulu::PrintJobStatus)
    end
  end
