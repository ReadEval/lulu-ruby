...
# Unit tests for Lulu::InlineResponse200LineItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse200LineItems' do
  before do
    # run before each test
    @instance = Lulu::InlineResponse200LineItems.new
  end
  ...
  describe 'test an instance of InlineResponse200LineItems' do
    it 'should create an instance of InlineResponse200LineItems' do
      expect(@instance).to be_instance_of(Lulu::InlineResponse200LineItems)
    end
  end
  describe 'test attribute "reprint"' do
    it 'should work' do
  ...
  describe 'test attribute "pod_package_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "printable_normalization"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "printable_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "printable"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
