...
# Unit tests for Lulu::PrintjobsStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintjobsStatus' do
  before do
    # run before each test
    @instance = Lulu::PrintjobsStatus.new
  end
  ...
  describe 'test an instance of PrintjobsStatus' do
    it 'should create an instance of PrintjobsStatus' do
      expect(@instance).to be_instance_of(Lulu::PrintjobsStatus)
    end
  end
  describe 'test attribute "name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["CREATED", "ACCEPTED", "REJECTED", "IN_PRODUCTION", "ERROR", "SHIPPED"])
