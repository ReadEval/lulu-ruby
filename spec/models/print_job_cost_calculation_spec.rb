...
# Unit tests for Lulu::PrintJobCostCalculation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintJobCostCalculation' do
  before do
    # run before each test
    @instance = Lulu::PrintJobCostCalculation.new
  end
  ...
  describe 'test an instance of PrintJobCostCalculation' do
    it 'should create an instance of PrintJobCostCalculation' do
      expect(@instance).to be_instance_of(Lulu::PrintJobCostCalculation)
    end
  end
  describe 'test attribute "shipping_option"' do
    it 'should work' do
      ...
      #   expect { @instance.shipping_option = value }.not_to raise_error
      # end
    end
  end
