...
# Unit tests for Lulu::PrintJobLineItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintJobLineItem' do
  before do
    # run before each test
    @instance = Lulu::PrintJobLineItem.new
  end
  ...
  describe 'test an instance of PrintJobLineItem' do
    it 'should create an instance of PrintJobLineItem' do
      expect(@instance).to be_instance_of(Lulu::PrintJobLineItem)
    end
  end
