...
# Unit tests for Lulu::PrintjobsEstimatedShippingDates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintjobsEstimatedShippingDates' do
  before do
    # run before each test
    @instance = Lulu::PrintjobsEstimatedShippingDates.new
  end
  ...
  describe 'test an instance of PrintjobsEstimatedShippingDates' do
    it 'should create an instance of PrintjobsEstimatedShippingDates' do
      expect(@instance).to be_instance_of(Lulu::PrintjobsEstimatedShippingDates)
    end
  end
  describe 'test attribute "dispatch_min"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "dispatch_max"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "arrival_min"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "arrival_max"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
