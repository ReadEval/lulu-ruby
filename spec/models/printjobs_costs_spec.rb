...
# Unit tests for Lulu::PrintjobsCosts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintjobsCosts' do
  before do
    # run before each test
    @instance = Lulu::PrintjobsCosts.new
  end
  ...
  describe 'test an instance of PrintjobsCosts' do
    it 'should create an instance of PrintjobsCosts' do
      expect(@instance).to be_instance_of(Lulu::PrintjobsCosts)
    end
  end
  ...
  describe 'test attribute "line_item_costs"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
