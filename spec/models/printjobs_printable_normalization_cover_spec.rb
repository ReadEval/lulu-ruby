...
# Unit tests for Lulu::PrintjobsPrintableNormalizationCover
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintjobsPrintableNormalizationCover' do
  before do
    # run before each test
    @instance = Lulu::PrintjobsPrintableNormalizationCover.new
  end
  ...
  describe 'test an instance of PrintjobsPrintableNormalizationCover' do
    it 'should create an instance of PrintjobsPrintableNormalizationCover' do
      expect(@instance).to be_instance_of(Lulu::PrintjobsPrintableNormalizationCover)
    end
  end
