...
# Unit tests for Lulu::PrintJobCost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintJobCost' do
  before do
    # run before each test
    @instance = Lulu::PrintJobCost.new
  end
  ...
  describe 'test an instance of PrintJobCost' do
    it 'should create an instance of PrintJobCost' do
      expect(@instance).to be_instance_of(Lulu::PrintJobCost)
    end
  end
