...
# Unit tests for Lulu::InlineResponse201ShippingCost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse201ShippingCost' do
  before do
    # run before each test
    @instance = Lulu::InlineResponse201ShippingCost.new
  end
  ...
  describe 'test an instance of InlineResponse201ShippingCost' do
    it 'should create an instance of InlineResponse201ShippingCost' do
      expect(@instance).to be_instance_of(Lulu::InlineResponse201ShippingCost)
    end
  end
