...
# Unit tests for Lulu::PrintjobsLineItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintjobsLineItems' do
  before do
    # run before each test
    @instance = Lulu::PrintjobsLineItems.new
  end
  ...
  describe 'test an instance of PrintjobsLineItems' do
    it 'should create an instance of PrintjobsLineItems' do
      expect(@instance).to be_instance_of(Lulu::PrintjobsLineItems)
    end
  end
