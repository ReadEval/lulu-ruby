...
# Unit tests for Lulu::PrintJobLineItemCost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintJobLineItemCost' do
  before do
    # run before each test
    @instance = Lulu::PrintJobLineItemCost.new
  end
  ...
  describe 'test an instance of PrintJobLineItemCost' do
    it 'should create an instance of PrintJobLineItemCost' do
      expect(@instance).to be_instance_of(Lulu::PrintJobLineItemCost)
    end
  end
