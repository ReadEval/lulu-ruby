...
# Unit tests for Lulu::PrintjobcostcalculationsLineItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintjobcostcalculationsLineItems' do
  before do
    # run before each test
    @instance = Lulu::PrintjobcostcalculationsLineItems.new
  end
  ...
  describe 'test an instance of PrintjobcostcalculationsLineItems' do
    it 'should create an instance of PrintjobcostcalculationsLineItems' do
      expect(@instance).to be_instance_of(Lulu::PrintjobcostcalculationsLineItems)
    end
  end
