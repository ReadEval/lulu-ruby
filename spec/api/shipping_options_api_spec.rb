...
# Unit tests for Lulu::ShippingOptionsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ShippingOptionsApi' do
  before do
    # run before each test
    @instance = Lulu::ShippingOptionsApi.new
  end
  ...
  describe 'test an instance of ShippingOptionsApi' do
    it 'should create an instance of ShippingOptionsApi' do
      expect(@instance).to be_instance_of(Lulu::ShippingOptionsApi)
    end
  end

  # unit tests for deprecated_shipping_options_list
  ...
  # @return [nil]
  describe 'deprecated_shipping_options_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for shipping_options_list
  # Retrieve List of Shipping Options
  ...
  # @return [Object]
  describe 'shipping_options_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
