...
# Unit tests for Lulu::PrintJobsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PrintJobsApi' do
  before do
    # run before each test
    @instance = Lulu::PrintJobsApi.new
  end
  ...
  describe 'test an instance of PrintJobsApi' do
    it 'should create an instance of PrintJobsApi' do
      expect(@instance).to be_instance_of(Lulu::PrintJobsApi)
    end
  end

  # unit tests for print_jobs_costs
  # Retrieve Print-Job Costs
  # Sub-resource to retrieve only the costs of a Print-Job
  # @param id Id of the resource
  # @param [Hash] opts the optional parameters
  # @return [InlineResponse2001]
  describe 'print_jobs_costs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for print_jobs_create
  ...
  describe 'print_jobs_create test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for print_jobs_list
  ...
  # @return [Object]
  describe 'print_jobs_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for print_jobs_read
  # Retrieve a single Print-Job
  # Retrieve a single Print-Job by id.
  # @param id Id of the resource
  # @param [Hash] opts the optional parameters
  # @return [InlineResponse200]
  describe 'print_jobs_read test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for print_jobs_statistics
  ...
  # @option opts [String] :ordering Which field to use when ordering the results.
  # @return [Object]
  describe 'print_jobs_statistics test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for print_jobs_status_read
  # Retrieve Print-Job Status
  # Sub-resource that represents the status of a Print-Job
  # @param id Id of the resource
  # @param [Hash] opts the optional parameters
  # @return [InlineResponse2002]
  describe 'print_jobs_status_read test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
