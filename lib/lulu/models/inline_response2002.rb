...
module Lulu
  ...
  class InlineResponse2002
    ...
    def valid?
      ...
      name_validator = EnumAttributeValidator.new('String', ['CREATED', 'REJECTED', 'UNPAID', 'PAYMENT_IN_PROGRESS', 'PRODUCTION_READY', 'PRODUCTION_DELAYED', 'IN_PRODUCTION', 'ERROR', 'SHIPPED', 'CANCELED'])
