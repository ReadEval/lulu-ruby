...
module Lulu
  ...
  class InlineResponse200LineItems
    ...
    # The title of the line item. Should be on the cover. This field will become mandatory on June 30, 2019!
    attr_accessor :title
    ...
    attr_accessor :pod_package_id

    # The page count of the printable
    attr_accessor :page_count

    attr_accessor :printable_normalization
    ...
    def self.attribute_map
      {
        ...
        :'printable_normalization' => :'printable_normalization',
        :'interior' => :'interior',
        :'cover' => :'cover',
    ...
    def self.openapi_types
      {
        :'reprint' => :'InlineResponse200Reprint',
        :'id' => :'Float',
        :'status' => :'PrintjobsStatus',
        :'external_id' => :'String',
        :'title' => :'String',
        :'quantity' => :'Float',
        :'tracking_id' => :'String',
        ...
        :'page_count' => :'Float',
        :'printable_normalization' => :'PrintjobsPrintableNormalization',
        :'interior' => :'Object',
        :'cover' => :'Object',
        :'printable_id' => :'String',
        :'printable' => :'String'
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reprint')
        self.reprint = attributes[:'reprint']
      end
      ...
      if attributes.has_key?(:'tracking_urls')
        if (value = attributes[:'tracking_urls']).is_a?(Array)
          self.tracking_urls = value
        end
      end

      if attributes.has_key?(:'pod_package_id')
        self.pod_package_id = attributes[:'pod_package_id']
      end
      ...
      if attributes.has_key?(:'printable_normalization')
        self.printable_normalization = attributes[:'printable_normalization']
      end

      if attributes.has_key?(:'interior')
        self.interior = attributes[:'interior']
      end

      if attributes.has_key?(:'cover')
        self.cover = attributes[:'cover']
      end

      if attributes.has_key?(:'printable_id')
        self.printable_id = attributes[:'printable_id']
      end

      if attributes.has_key?(:'printable')
        self.printable = attributes[:'printable']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@pod_package_id.nil? && @pod_package_id.to_s.length > 27
        invalid_properties.push('invalid value for "pod_package_id", the character length must be smaller than or equal to 27.')
      end
    ...
    def valid?
      ...
      return false if !@pod_package_id.nil? && @pod_package_id.to_s.length > 27
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] pod_package_id Value to be assigned
    def pod_package_id=(pod_package_id)
      if !pod_package_id.nil? && pod_package_id.to_s.length > 27
        fail ArgumentError, 'invalid value for "pod_package_id", the character length must be smaller than or equal to 27.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pod_package_id == o.pod_package_id &&
          page_count == o.page_count &&
          printable_normalization == o.printable_normalization &&
          interior == o.interior &&
          cover == o.cover &&
          printable_id == o.printable_id &&
    ...
    def hash
      [reprint, id, status, external_id, title, quantity, tracking_id, tracking_urls, pod_package_id, page_count, printable_normalization, interior, cover, printable_id, printable].hash
    end
