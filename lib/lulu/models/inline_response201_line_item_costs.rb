...
module Lulu
  ...
  class InlineResponse201LineItemCosts
    ...
    attr_accessor :cost_excl_discounts
    ...
    attr_accessor :total_cost_excl_discounts
    ...
    def self.openapi_types
      {
        ...
        :'tax_rate' => :'String',
        :'discounts' => :'Array<InlineResponse201Discounts>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cost_excl_discounts')
        self.cost_excl_discounts = attributes[:'cost_excl_discounts']
      end
      ...
      if attributes.has_key?(:'total_cost_excl_discounts')
        self.total_cost_excl_discounts = attributes[:'total_cost_excl_discounts']
      end
      ...
      if attributes.has_key?(:'total_cost_excl_tax')
        self.total_cost_excl_tax = attributes[:'total_cost_excl_tax']
      end

      if attributes.has_key?(:'total_cost_incl_tax')
        self.total_cost_incl_tax = attributes[:'total_cost_incl_tax']
      end

      if attributes.has_key?(:'unit_tier_cost')
        self.unit_tier_cost = attributes[:'unit_tier_cost']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @cost_excl_discounts.nil?
        invalid_properties.push('invalid value for "cost_excl_discounts", cost_excl_discounts cannot be nil.')
      end
      ...
      if @total_cost_excl_discounts.nil?
        invalid_properties.push('invalid value for "total_cost_excl_discounts", total_cost_excl_discounts cannot be nil.')
      end
      ...
      if @total_cost_excl_tax.nil?
        invalid_properties.push('invalid value for "total_cost_excl_tax", total_cost_excl_tax cannot be nil.')
      end

      if @total_cost_incl_tax.nil?
        invalid_properties.push('invalid value for "total_cost_incl_tax", total_cost_incl_tax cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @cost_excl_discounts.nil?
      return false if @tax_rate.nil?
      return false if @discounts.nil?
      return false if @total_cost_excl_discounts.nil?
      return false if @total_tax.nil?
      return false if @total_cost_excl_tax.nil?
      return false if @total_cost_incl_tax.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          quantity == o.quantity &&
          cost_excl_discounts == o.cost_excl_discounts &&
          tax_rate == o.tax_rate &&
          discounts == o.discounts &&
          total_cost_excl_discounts == o.total_cost_excl_discounts &&
          total_tax == o.total_tax &&
          total_cost_excl_tax == o.total_cost_excl_tax &&
          total_cost_incl_tax == o.total_cost_incl_tax &&
          unit_tier_cost == o.unit_tier_cost
    end
    ...
    def hash
      [quantity, cost_excl_discounts, tax_rate, discounts, total_cost_excl_discounts, total_tax, total_cost_excl_tax, total_cost_incl_tax, unit_tier_cost].hash
    end
