...
module Lulu
  ...
  class PrintjobcostcalculationsLineItems
    ...
    def list_invalid_properties
      ...
      if @pod_package_id.nil?
        invalid_properties.push('invalid value for "pod_package_id", pod_package_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pod_package_id.nil?
    ...
    def hash
      [quantity, pod_package_id, page_count].hash
    end
