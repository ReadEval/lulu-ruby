...
module Lulu
  ...
  class PrintjobcostcalculationsShippingAddress
    attr_accessor :title
    ...
    def hash
      [title, name, organization, street1, street2, city, state_code, country_code, postcode, phone_number, email, is_business].hash
    end
