...
module Lulu
  ...
  class PrintjobsEstimatedShippingDates
    # The fastest estimated ship date for a Print-Job
    attr_accessor :dispatch_min

    # The slowest estimated ship date for a Print-Job
    attr_accessor :dispatch_max

    # The fastest estimated delivery date for a Print-Job
    attr_accessor :arrival_min

    # The slowest estimated delivery date for a Print-Job
    attr_accessor :arrival_max
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dispatch_min')
        self.dispatch_min = attributes[:'dispatch_min']
      end

      if attributes.has_key?(:'dispatch_max')
        self.dispatch_max = attributes[:'dispatch_max']
      end

      if attributes.has_key?(:'arrival_min')
        self.arrival_min = attributes[:'arrival_min']
      end

      if attributes.has_key?(:'arrival_max')
        self.arrival_max = attributes[:'arrival_max']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          dispatch_min == o.dispatch_min &&
          dispatch_max == o.dispatch_max &&
          arrival_min == o.arrival_min &&
          arrival_max == o.arrival_max
    end
    ...
    def hash
      [dispatch_min, dispatch_max, arrival_min, arrival_max].hash
    end
