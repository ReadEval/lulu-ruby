...
module Lulu
  ...
  class PrintJobsStatistics
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ['CREATED', 'REJECTED', 'UNPAID', 'PAYMENT_IN_PROGRESS', 'PRODUCTION_READY', 'PRODUCTION_DELAYED', 'IN_PRODUCTION', 'ERROR', 'SHIPPED', 'CANCELED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['CREATED', 'REJECTED', 'UNPAID', 'PAYMENT_IN_PROGRESS', 'PRODUCTION_READY', 'PRODUCTION_DELAYED', 'IN_PRODUCTION', 'ERROR', 'SHIPPED', 'CANCELED'])
