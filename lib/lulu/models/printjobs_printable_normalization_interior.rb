...
module Lulu
  ...
  class PrintjobsPrintableNormalizationInterior
    # The url of the source file.
    attr_accessor :source_url

    # A md5 hash of the source file to check it's integrity
    attr_accessor :source_md5_sum
    ...
    def self.openapi_types
      {
        ...
        :'normalized_file' => :'PrintjobsPrintableNormalizationInteriorNormalizedFile',
        :'job_id' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'source_md5_sum')
        self.source_md5_sum = attributes[:'source_md5_sum']
      end

      if attributes.has_key?(:'normalized_file')
        self.normalized_file = attributes[:'normalized_file']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          source_md5_sum == o.source_md5_sum &&
          normalized_file == o.normalized_file &&
          job_id == o.job_id
    end
    ...
    def hash
      [source_url, source_md5_sum, normalized_file, job_id].hash
    end
