...
module Lulu
  ...
  class InlineResponse201
    ...
    def self.attribute_map
      {
        ...
        :'line_item_costs' => :'line_item_costs',
    ...
    def self.openapi_types
      {
        :'shipping_cost' => :'InlineResponse201ShippingCost',
        :'line_item_costs' => :'Array<InlineResponse201LineItemCosts>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'line_item_costs')
        if (value = attributes[:'line_item_costs']).is_a?(Array)
          self.line_item_costs = value
        end
      end
      ...
      if attributes.has_key?(:'total_discount_amount')
    ...
    def list_invalid_properties
      ...
      if @line_item_costs.nil?
        invalid_properties.push('invalid value for "line_item_costs", line_item_costs cannot be nil.')
      end
      ...
      if @total_discount_amount.nil?
        invalid_properties.push('invalid value for "total_discount_amount", total_discount_amount cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          line_item_costs == o.line_item_costs &&
    ...
    def hash
      [shipping_cost, line_item_costs, total_cost_excl_tax, total_cost_incl_tax, total_discount_amount, total_tax, currency].hash
    end
