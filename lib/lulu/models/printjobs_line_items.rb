...
module Lulu
  ...
  class PrintjobsLineItems
    ...
    def hash
      [id, status, external_id, title, quantity, tracking_id, tracking_urls, pod_package_id, page_count, printable_normalization, interior, cover, printable_id, printable].hash
    end
