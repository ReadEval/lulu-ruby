...
module Lulu
  ...
  class InlineResponse200Reprint
    ...
    def list_invalid_properties
      ...
      if @defect.nil?
        invalid_properties.push('invalid value for "defect", defect cannot be nil.')
      end

      if @defect.to_s.length > 100
        invalid_properties.push('invalid value for "defect", the character length must be smaller than or equal to 100.')
      end
    ...
    def valid?
      return false if @defect.nil?
      return false if @defect.to_s.length > 100
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] defect Value to be assigned
    def defect=(defect)
      if defect.nil?
        fail ArgumentError, 'defect cannot be nil'
      end

      if defect.to_s.length > 100
        fail ArgumentError, 'invalid value for "defect", the character length must be smaller than or equal to 100.'
      end
