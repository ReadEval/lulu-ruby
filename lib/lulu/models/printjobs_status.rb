...
module Lulu
  ...
  class PrintjobsStatus
    ...
    def self.openapi_types
      {
        :'name' => :'String',
        :'messages' => :'PrintjobsStatusMessages'
      }
    end
    ...
    def valid?
      ...
      name_validator = EnumAttributeValidator.new('String', ['CREATED', 'ACCEPTED', 'REJECTED', 'IN_PRODUCTION', 'ERROR', 'SHIPPED'])
    ...
    def name=(name)
      validator = EnumAttributeValidator.new('String', ['CREATED', 'ACCEPTED', 'REJECTED', 'IN_PRODUCTION', 'ERROR', 'SHIPPED'])
