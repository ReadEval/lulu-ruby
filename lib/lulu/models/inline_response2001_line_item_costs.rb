...
module Lulu
  ...
  class InlineResponse2001LineItemCosts
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'line_item_external_id')
        self.line_item_external_id = attributes[:'line_item_external_id']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @line_item_external_id.nil?
        invalid_properties.push('invalid value for "line_item_external_id", line_item_external_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @line_item_external_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          line_item_external_id == o.line_item_external_id
    end
    ...
    def hash
      [line_item_id, line_item_external_id].hash
    end
