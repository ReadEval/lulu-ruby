  ...
  class PrintjobsCosts
    ...
    def self.openapi_types
      {
        ...
        :'line_item_costs' => :'InlineResponse201LineItemCosts'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'line_item_costs')
        self.line_item_costs = attributes[:'line_item_costs']
      end
    end
    ...
    def hash
      [total_cost_excl_tax, total_cost_incl_tax, total_tax, shipping_cost, line_item_costs].hash
    end
