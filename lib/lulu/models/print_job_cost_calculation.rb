...
module Lulu
  ...
  class PrintJobCostCalculation
    ...
    def self.openapi_types
      {
        ...
        :'shipping_address' => :'PrintjobcostcalculationsShippingAddress',
        :'line_items' => :'Array<PrintjobcostcalculationsLineItems>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shipping_option')
    ...
    def valid?
      ...
      shipping_option_validator = EnumAttributeValidator.new('String', ['MAIL', 'PRIORITY_MAIL', 'GROUND_HD', 'GROUND_BUS', 'GROUND', 'EXPEDITED', 'EXPRESS'])
      return false unless shipping_option_validator.valid?(@shipping_option)
    ...
    # @param [Object] shipping_option Object to be assigned
    def shipping_option=(shipping_option)
      validator = EnumAttributeValidator.new('String', ['MAIL', 'PRIORITY_MAIL', 'GROUND_HD', 'GROUND_BUS', 'GROUND', 'EXPEDITED', 'EXPRESS'])
      unless validator.valid?(shipping_option)
        fail ArgumentError, 'invalid value for "shipping_option", must be one of #{validator.allowable_values}.'
      end
      @shipping_option = shipping_option
    end
    ...
    def hash
      [shipping_option, shipping_address, line_items].hash
    end
