...
module Lulu
  ...
  class PrintJobDetail
    ...
    def self.openapi_types
      {
        :'parent_job_id' => :'Float',
        :'child_job_ids' => :'Array<Float>',
        :'line_items' => :'Array<InlineResponse200LineItems>',
        :'items' => :'Array<InlineResponse200LineItems>',
        :'id' => :'Float',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'parent_job_id')
        self.parent_job_id = attributes[:'parent_job_id']
      end

      if attributes.has_key?(:'child_job_ids')
        if (value = attributes[:'child_job_ids']).is_a?(Array)
          self.child_job_ids = value
        end
      end
    ...
    def hash
      [parent_job_id, child_job_ids, line_items, items, id, shipping_level, shipping_option_level, estimated_shipping_dates, contact_email, shipping_address, production_delay, production_due_time, order_id, tax_country, external_id, costs].hash
    end
