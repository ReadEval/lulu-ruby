...
module Lulu
  ...
  class PrintjobsStatusMessages
    ...
    def self.openapi_types
      {
        :'info' => :'String',
        :'printable_normalization' => :'PrintjobsStatusMessagesPrintableNormalization',
        :'url' => :'Object',
        :'error' => :'String',
        :'delay' => :'String',
        :'timestamp' => :'String'
    ...
    def list_invalid_properties
      ...
      if !@delay.nil? && @delay.to_s.length > 64
        invalid_properties.push('invalid value for "delay", the character length must be smaller than or equal to 64.')
      end

      if !@timestamp.nil? && @timestamp.to_s.length > 64
        invalid_properties.push('invalid value for "timestamp", the character length must be smaller than or equal to 64.')
      end
    ...
    def valid?
      return false if !@delay.nil? && @delay.to_s.length > 64
      return false if !@timestamp.nil? && @timestamp.to_s.length > 64
      true
    end
    ...
    def delay=(delay)
      if !delay.nil? && delay.to_s.length > 64
        fail ArgumentError, 'invalid value for "delay", the character length must be smaller than or equal to 64.'
      end
    ...
    def timestamp=(timestamp)
      if !timestamp.nil? && timestamp.to_s.length > 64
        fail ArgumentError, 'invalid value for "timestamp", the character length must be smaller than or equal to 64.'
      end
    ...
    def hash
      [info, printable_normalization, url, error, delay, timestamp].hash
    end
