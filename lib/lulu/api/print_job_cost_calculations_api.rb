...
module Lulu
  class PrintJobCostCalculationsApi
    ...
    def print_job_cost_calculations_create(opts = {})
      data, _status_code, _headers = print_job_cost_calculations_create_with_http_info(opts)
      data
    end
    ...
    def print_job_cost_calculations_create_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PrintJobCostCalculationsApi.print_job_cost_calculations_create ...'
      end
      # resource path
      local_var_path = '/print-job-cost-calculations/'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PrintJobCostCalculationsApi#print_job_cost_calculations_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
